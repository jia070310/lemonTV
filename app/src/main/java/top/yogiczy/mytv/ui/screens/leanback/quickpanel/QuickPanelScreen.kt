...
import top.yogiczy.mytv.ui.screens.leanback.quickpanel.components.LeanbackQuickPanelIptvSourceDialog
...
fun LeanbackQuickPanelScreen(
    ...
    onSwitchSource: (String) -> Unit = {},  // 新增：切换源回调
    onMoreSettings: () -> Unit = {},
    onClose: () -> Unit = {},
    ...
    var showSourceDialog by remember { mutableStateOf(false) }  // 新增：控制对话框显示
    ...
    Box(
        ...
        Box(
            ...
            Column(
                ...
                Row(
                    ...
                    LeanbackQuickPanelButton(
                        titleProvider = { "切换源" },
                        onSelect = { showSourceDialog = true },
                    )
                    ...
                    LeanbackQuickPanelButton(
                        ...
                        showBadgeProvider = hasUpdateProvider,  // 显示红点
                    )
                }
            }
        }
        ...
        // 源选择对话框
        LeanbackQuickPanelIptvSourceDialog(
            showDialogProvider = { showSourceDialog },
            currentSourceUrlProvider = { top.yogiczy.mytv.ui.utils.SP.iptvSourceUrl },
