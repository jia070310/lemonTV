...
class LeanbackSettingsViewModel : ViewModel() {
    ...
    var iptvSourceNameMap: Map<String, String>
        ...
        set(value) {
            _iptvSourceNameMap = value
            SP.iptvSourceNameMap = value
        }

    private var _iptvSourceDefaultUrl by mutableStateOf(SP.iptvSourceDefaultUrl)
    var iptvSourceDefaultUrl: String
        get() = _iptvSourceDefaultUrl
        set(value) {
            _iptvSourceDefaultUrl = value
            SP.iptvSourceDefaultUrl = value
        }
    ...
    private var _videoPlayerUserAgentHistoryList by mutableStateOf(SP.videoPlayerUserAgentHistoryList)
    var videoPlayerUserAgentHistoryList: Set<String>
        get() = _videoPlayerUserAgentHistoryList
        set(value) {
            _videoPlayerUserAgentHistoryList = value
            SP.videoPlayerUserAgentHistoryList = value
        }
